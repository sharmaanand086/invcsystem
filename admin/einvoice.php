    ...
    if($taxtype == 'T'){
            	...
            	if ($app->cfgCon("connectionName")) 
            {
	          ...
	          $stf= '<img src="images/smashxLogo.jpg" style="width:20%;">
	        	<p style="width:100%;text-align:center;font-size:24px;border-bottom: 1px solid #000;height: 35px;"> Tax-Invoice	</p>';
	    ...
	    if($taxtype == 'P'){
	       ...
	       $stf='<img src="images/smashxLogo.jpg" style="width:20%;">
	        	<p style="width:100%;text-align:center;font-size:24px;border-bottom: 1px solid #000;height: 35px;">Proforma-Invoice	</p>';
						...
						<tbody>
							...
							<tr>
								<td class="info" style="padding:3px;font-size: 12px;color: #000000;text-align: center;border: 2px solid #000000;">
									<p id="date" style="text-align: center; margin-top: 0px; margin-bottom: 0px; height: 31px;">'.$_POST['invoicedate'].'</p>
								</td>
								<td class="info" style="padding:3px;font-size: 12px;color: #000000;text-align:center;border: 2px solid #000000;">
									<p style="text-align:center;margin-top: 0px; margin-bottom: 0px; height: 31px;">'.$_POST['invoicenumber'].'</p>
								</td>
							</tr>
						</tbody>
						</table>
...
include('pdf.php');
 ...
 move_uploaded_file($file_name, "$dir".$file);
   ...
   $email1 = $_POST['tag'];
   $price1 = $_POST['price'];
   $date1 = $_POST['invoicedate'];
   $place1 = $_POST['place'];
   $sgst1 = $_POST['sgst9'];
    $cgst1 = $_POST['cgst9'];
     $igst1 = $_POST['igst18'];
     $totamt1 =$_POST['totamt'];
   $updatedat1 =date('Y-m-d H:i:s');
$new_pdf = $file_name;
		$pro1 = $conn->query("UPDATE `invoicesystem` SET `invoicedate`='$date1',`name`='$name1', `tag`='$email1',`phone`='$phone1',`gstnumber`='$gstnumber1', 
		`price`='$price1' , `place`='$place1' , `updatedat`='$updatedat1',`igst18%`='$igst1',`sgst9`='$sgst1',`cgst9`='$cgst1',`totamt`='$totamt1',`newpdf`='$new_pdf' WHERE id='$eid'");
		if($pro1 == 1)
		{
